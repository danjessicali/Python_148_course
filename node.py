class LinkedListNode:
    ...
    def __eq__(self, other):
         ...
         while (self_node is not None and isinstance(self_node,other_node) and
             self_node.value is other_node.value):
             self_node,other_node = self.next_,other_node.next_
...
class LinkedList:
    ...
    def __eq__(self, other):
         ...
         True
         """
         return (type(self) == type(other) and (self.front,self.back,self.size)\
